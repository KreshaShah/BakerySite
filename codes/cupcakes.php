...
<br><br><br><br>
  <div class="container-fluid">
    <div class="col-md-12">
      <div class="row">
        <div class="col-md-6">
          <h2 class="text-center">Products available</h2>
          <div class="col-md-12">
            <div class= "row">
          ...
          <div class="col-md-6">
            ...
            <form method="post" action="cupcakes.php?id=<?=$row['id']?>">
        ...
        <h2 class= "text-center">Your Cart</h2>
          ...
          if(!empty($_SESSION['cart'])){
            ...
            foreach($_SESSION['cart'] as $key => $value){
              ...
              <td><a href= 'cupcakes.php?action=remove&id=".$value['id']."'>
            ...
            <td>
            <a href = 'cupcakes.php?action=clearall'>
